...
#define LOCAL_APIC_LVT_LINT0 \
    0x350  // Local Interrupt 0 Local Vector Table Entry
#define LOCAL_APIC_LVT_LINT1 \
    0x360  // Local Interrupt 1 Local Vector Table Entry
