namespace mixins::std {
    ...
    template <>
    struct isIntegral<unsigned char> : Constant<bool, true>
    {};
    template <>
    struct isIntegral<unsigned short> : Constant<bool, true>
    {};
    template <>
    struct isIntegral<unsigned int> : Constant<bool, true>
    {};
    template <>
    struct isIntegral<unsigned long> : Constant<bool, true>
    {};
    template <>
    struct isIntegral<unsigned long long> : Constant<bool, true>
    {};
    template <>
    struct isIntegral<char> : Constant<bool, true>
    {};
    template <>
    struct isIntegral<short> : Constant<bool, true>
    {};
    template <>
    struct isIntegral<int> : Constant<bool, true>
    {};
    template <>
    struct isIntegral<long> : Constant<bool, true>
    {};
    template <>
    struct isIntegral<long long> : Constant<bool, true>
    {};
    ...
    template <>
    struct isFloatingPoint<float> : Constant<bool, true>
    {};
    template <>
    struct isFloatingPoint<double> : Constant<bool, true>
    {};
    template <>
    struct isFloatingPoint<long double> : Constant<bool, true>
    {};

    template <typename T>
    using isArithmetic =
      Constant<bool, isIntegral<T>::value || isFloatingPoint<T>::value>;

    template <typename _Func, typename... _Args>
    concept isCallable =
      requires(_Func f, _Args... args) { f(declval<_Args>()...); };
    ...
    template <typename _Tp>
    struct isLvalueReference : Constant<bool, false>
    {};

    template <typename _Tp>
    struct isLvalueReference<_Tp&> : Constant<bool, true>
    {};

    template <typename _Tp>
    struct isRvalueReference : Constant<bool, false>
    {};

    template <typename _Tp>
    struct isRvalueReference<_Tp&&> : Constant<bool, true>
    {};
    ...
    template <typename T1, typename T2>
    concept SameAs = IsSame<T1, T2>::value;
    ...
    template <typename T>
    struct isTrivial : public Constant<bool, __is_trivial(T)>
    {
        static_assert(
          __isCompleteOrUnbounded(TypeIdentity<T>{}),
